...
try {
    ...
    products.forEach(product => {
        ...
        if (mapItem) {
            // Find the most recent file matching the pattern if there are multiples (or just the first one found)
            // The naming convention seen previously was like 'cpu_product_1766685631184.png'
            ...
            if (matchingFile) {
                ...
                if (product.imageUrl !== dataUrl) {
                    ...
                    console.log(`Product ${product.id} already has correct image data.`);
                }
            } else {
